...
func TestUnits(t *testing.T) {
	...
	d := units[DaemonUnit]
	if !strings.Contains(d, "--network-backend auto") || !strings.Contains(d, "ReadWritePaths=/etc/ostiole /etc/systemd/network /usr/local/bin -/etc/dnsmasq.d -/etc/resolv.conf -/etc/ppp") {
