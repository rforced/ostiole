...
func (c *Config) DerivedCrons() []Cron {
	...
	return []Cron{
		...
		},
		{
			...
			Description: "Copy an encrypted backup of the configuration to the bucket",
		...
		},
		{
			...
			Description: "Renew the certificates that are due and issue the ones that are missing",
