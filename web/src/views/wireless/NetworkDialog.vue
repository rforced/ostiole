...
<template>
  <AppDialog
    v-model:open="open"
    :title="network ? `Network ${network.wireless.ssid}` : 'New wireless network'"
  ...
  >
    <form class="space-y-4" @submit.prevent="save">
      ...
      <fieldset class="space-y-2">
        <legend class="text-sm font-medium">Attach</legend>
      ...
      <div class="space-y-2">
        <label class="flex items-center gap-2 text-sm">
          <input v-model="form.hidden" type="checkbox" class="size-4 rounded border-neutral-300" />
          Hidden
        </label>
        <label class="flex items-center gap-2 text-sm">
          <input v-model="form.isolate" type="checkbox" class="size-4 rounded border-neutral-300" />
          Isolate clients
          <span class="text-neutral-500">Clients cannot reach each other.</span>
        </label>
        <label class="flex items-center gap-2 text-sm">
