 ...
 * @property {boolean} [ownHeader] the page renders PageHeader itself, to fill its slots
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        path: 'certificates',
        label: 'Certificates',
        view: () => import('@/views/system/CertificatesPage.vue'),
        needsConfig: true,
        tabs: [
          { value: 'certificates', label: 'Certificates' },
          { value: 'accounts', label: 'ACME accounts' },
          { value: 'providers', label: 'DNS providers' },
        ],
      },
      {
        path: 'accounts',
  ...
  },
  {
    ...
    pages: [
      ...
      },
      {
        path: 'modem',
        label: 'Modem',
        view: () => import('@/views/diagnostics/ModemPage.vue'),
      },
      {
        path: 'drives',
        ownHeader: true,
        label: 'Drives',
        view: () => import('@/views/diagnostics/DrivesPage.vue'),
      },
